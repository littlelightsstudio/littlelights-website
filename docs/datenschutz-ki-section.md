# Datenschutzerklärung — KI-Abschnitt

Paste-ready-Abschnitt für die Datenschutzerklärung in Payload (`/datenschutz`-Page). In den bestehenden RichText-Block einfügen, vorzugsweise zwischen "Empfänger / Auftragsverarbeiter" und "Betroffenenrechte". Vor Live-Schaltung Anwalts-Review einplanen.
...
Standard-Postproduktionssoftware mit integrierten KI-Funktionen. Adobe ist nach dem EU-US Data Privacy Framework zertifiziert. Wir haben Trainingsdaten-Nutzung für Cloud-synchronisierte Inhalte deaktiviert. Weiterführende Informationen: [adobe.com/privacy](https://www.adobe.com/privacy.html).
